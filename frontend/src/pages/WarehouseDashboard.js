  ...
  return (
    <DashboardShell>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <div className="text-sm text-neutral-500">
              Hi {user?.full_name?.split(" ")[0] || "there"}, log products coming into the warehouse.
            </div>
          </div>
        </div>
          ...
          <div className="mb-6 bg-emerald-50 border border-emerald-200 rounded-2xl p-4 flex items-start gap-3 fade-in">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-emerald-900">
                Saved as {lastCreated.parcel_number}
              </div>
              <div className="text-xs text-emerald-800/80 mt-0.5 truncate">
                {lastCreated.products.map((p) => `${p.name} (${p.quantity})`).join(", ")} ·{" "}
                {lastCreated.num_packages} packages
                {lastCreated.company_name ? ` · ${lastCreated.company_name}` : ""}
              </div>
            </div>
            <button
        ...
        <form
          onSubmit={submit}
          className="bg-white border border-neutral-200 rounded-2xl divide-y divide-neutral-100"
        >
          {/* Parcel basics */}
          ...
          <div className="px-6 py-5">
            ...
            <p className="text-[11px] text-neutral-400 mt-1">
              Name of the person who handed over / submitted this stock.
            </p>
          </div>
          ...
          <div className="px-6 py-5">
            <div className="mb-3">
              ...
              <div className="text-xs text-neutral-500">
                Select how this stock was paid for. Choose{" "}
                <span className="font-medium">Unpaid</span> if no payment has been made yet.
              </div>
            </div>
          ...
          {/* Actions */}
          <div className="px-6 py-4 bg-neutral-50/60 flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={reset}
              disabled={submitting}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-200 text-sm text-neutral-700 hover:bg-white disabled:opacity-60"
            >
